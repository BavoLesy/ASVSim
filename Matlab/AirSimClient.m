classdef AirSimClient < handle
    ...
    methods(Static)        
        ...
        function vesselControls = getVesselControls()
            vesselClient = py.cosysairsim.VesselClient();
            vesselClient.confirmConnection();
            vesselControls = py.cosysairsim.VesselControls();
            vessel_disturbance_controls = py.cosysairsim.DisturbanceControls();
        end
    ...
    methods
        function obj = AirSimClient(varargin)
            ...
            if obj.is_drone
                ...
                obj.vessel_controls = AirSimClient.getVesselControls();
            end
        end     
        ...
        function [gnssData, timestamp, isValid] = getGpsData(obj, sensorName, vehicleName)
            ...
            gnssData.time_utc = double(double(gnssDataRaw{"time_utc"}))/1e9;   
        ...
        function [] = setVesselControls(obj, thrust, angle, vehicleName)
        ...
        function setDisturbanceControls(obj, wind_force, wind_angle, ...
            ...
            %
            % Description:
            %   Sets the wind, wave, and current parameters (direction and intensity) in the simulation.
            %
            % Inputs:
            %   wind_force - Force of the wind
            %   wind_heading - Heading of the wind
            %   wave_force - Force of the waves
            %   wave_heading - Heading of the waves
            %   current_speed - Speed of the current
            %   current_heading - Heading of the current
